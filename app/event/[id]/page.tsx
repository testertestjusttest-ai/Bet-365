...
export default function Event(){
 ...
 const [single,setSingle]=useState<BetPick[]>([]),[multiple,setMultiple]=useState<BetPick[]>([]),[ready,setReady]=useState(false),[userEmail,setUserEmail]=useState<string|null>(null),[authReady,setAuthReady]=useState(false);
