...
export default function HomePage(){
 ...
 const [loading,setLoading]=useState(true),[live,setLive]=useState<LiveEvent[]>([]),[liveLoading,setLiveLoading]=useState(true),[liveSource,setLiveSource]=useState("provider"),[eventSource,setEventSource]=useState("provider");
