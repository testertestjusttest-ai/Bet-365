...
export default function HomePage(){
 ...
 return <main className="app-shell">
  ...
  <nav className="bottom-nav"><a href="/sports"><Trophy/><span>Sports</span></a><a href="/casino"><span className="nav-emoji">🎰</span><span>Casino</span></a><a href="/bets" className="selected"><Ticket/><span>Bet slip</span></a><a href="/cashier"><span className="nav-emoji">💳</span><span>Deposit</span></a><a href="/menu"><span className="nav-emoji">☰</span><span>Menu</span></a></nav>
 </main>;
}