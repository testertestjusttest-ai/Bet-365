...
type Verify={id:string;user_id:string;legal_name:string|null;date_of_birth:string|null;country:string|null;document_type:string|null;status:"pending"|"under_review"|"approved"|"rejected";created_at:string};
...
export default function AdminPage(){
 ...
 async function load(){
  ...
  if(!usersRes.ok){setMessage(usersJson.error||"Access denied. This area is restricted to authorized staff.");return;}
 ...
 return <main className="app-shell admin-page">
  ...
  <div className="admin-wrap">
   <div className="admin-title"><div><span className="eyebrow">BACK OFFICE</span><h1>Admin control centre</h1><p>Role-based operations for account, KYC, cashier review and platform controls.</p></div><button className="admin-refresh" onClick={()=>load()} disabled={busy}><RefreshCw size={16}/> Refresh</button></div>
